...
public class MainActivity extends AppCompatActivity {
    ListView listView;
    Button button;
    String arr[] = {"This is", "Item", "Item2", "Another Item", "another", "nau", "Mail3", "Mail4","hey","hii","bye","how are you"};
    @Override
...
//        (Updated link thanks @Estel: https://github.com/android/platform_frameworks_base/tree/master/core/res/res/layout )
        ...
        HarryAdapter ad = new HarryAdapter(this, R.layout.my_yash_layout, arr);
        listView.setAdapter(ad);
